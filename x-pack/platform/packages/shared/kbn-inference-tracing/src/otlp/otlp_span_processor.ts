...
export class OTLPSpanProcessor extends BaseInferenceSpanProcessor {
  ...
  onStart(span: any, parentContext: any): void {
    ...
    // console.log(
    //   `OTLP onStart called for: ${span.name}, instrumentation: ${span.instrumentationScope?.name}`
    // );
    super.onStart(span, parentContext);
    // eslint-disable-next-line no-console
    // console.log(`OTLP onStart: _should_track = ${span.attributes?._should_track}`);
  }

  onEnd(span: any): void {
    // eslint-disable-next-line no-console
    // console.log(
    //   `OTLP onEnd called for: ${span.name}, _should_track = ${span.attributes?._should_track}`
    // );
    super.onEnd(span);
  }
  ...
  processInferenceSpan(span: tracing.ReadableSpan): tracing.ReadableSpan {
    // eslint-disable-next-line no-console
    console.log(`OTLP processInferenceSpan called for: ${span.name}`);
